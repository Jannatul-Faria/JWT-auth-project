        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-4 p-2">
                <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                    <div class="row">
                        <div class="col-8">
                            <img class="w-70 mb-4" src="{{ 'images/logo0.png' }}"><br>
                    ...
                    <hr class="mx-0 my-2 p-0 bg-info" />
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p>
                                <button onclick="createInvoice()" class="btn  my-3 bg-gradient-info w-40">Confirm</button>
                            </p>
                        </div>
