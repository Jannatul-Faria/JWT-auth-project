    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <p class="text-xs  mx-0 my-1">Name: <span id="CName" class="text-bold"></span> </p>
                            <p class="text-xs mx-0 my-1">Email: <span id="CEmail" class="text-bold"></span></p>
                            <p class="text-xs mx-0 my-1">User ID: <span id="CId" class="text-bold"></span> </p>
                        </div>

                        <div class="col-4">
                            <img class="w-50" src="{{ 'images/logo0.png' }}" id="invoice_img">
                            <p class="text-bold mx-5 my-1 text-dark">Invoice </p>
                            <p class="text-xs mx-5 my-1">Date: {{ date('Y-m-d') }} </p>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button onclick="PrintPage()" class="btn bg-gradient-info">Print</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    //     let logoSrc = document.querySelector('#invoice_img').src;
    //     let logoImg = `<img class="w-10" src="${logoSrc}">`;
    //     printContents = logoImg + printContents;
